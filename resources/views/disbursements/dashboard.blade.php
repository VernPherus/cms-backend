        ...
        <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-white sidebar shadow-sm collapse" style="min-height: 100vh;">
            <div class="position-sticky pt-4 px-3">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item mb-1">
                        <a class="nav-link text-secondary d-flex align-items-center gap-2 p-2 rounded hover-bg-light" href="#">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4 bg-light">
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-4 border-bottom">
                ...
                <div class="btn-toolbar mb-2 mb-md-0">
                    <a href="{{ route('disbursementadmin.create') }}" class="btn btn-primary d-flex align-items-center gap-2 shadow-sm">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex flex-column">
                                        ...
                                        <span class="small text-muted font-monospace">{{ $record->voucher_number }}</span>
                                    </div>
                                </td>
                                <td class="fw-medium text-dark">{{ $record->payee->name }}</td>
                                <td>
                                    <span class="badge bg-light text-secondary border border-secondary-subtle text-dark">
                                ...
                                <td class="text-center">
                                    <a href="{{ route('disbursements.details', $record->id) }}" class="btn btn-sm btn-outline-primary border-0 bg-primary-subtle text-primary">
